            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-link me-2 text-light text-shadow fw-100" href="histori/">Histori</a>
                    </div>
                        ...
                        <div class="swiper mySwiper">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <a class="text-decoration-none" href="/user/show/{{ $kursi->id }}">
                    ...
                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab"
                        ...
                        <div class="swiper mySwiper">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <a class="text-decoration-none" href="/user/show/{{ $sofa->id }}">
                                        <div class="card border-0">
                                            <img class="mx-auto d-block"
                    ...
                    <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab"
                        ...
                        <div class="swiper mySwiper">
                            <div class="swiper-wrapper">
                                @foreach ($dbed as $bed)
                                <div class="swiper-slide">
                                    <a class="text-decoration-none" href="/user/show/{{ $bed->id }}">
                                        <div class="card border-0">
                                            <img class="mx-auto d-block"
                    ...
                    <div class="tab-pane fade" id="nav-lamp" role="tabpanel" aria-labelledby="nav-lamp-tab"
                        ...
                        <div class="swiper mySwiper">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <a class="text-decoration-none" href="/user/show/{{ $lamp->id }}">
                                        <div class="card border-0">
                                            <img class="mx-auto d-block"
